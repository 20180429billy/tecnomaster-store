# Generated by Django 4.0 on 2023-05-28 21:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='privado.estadovaloraciones')),
                ('id_pedido', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='privado.pedido')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
        ...
        migrations.AddField(
            model_name='pedido',
            name='id_producto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='privado.producto'),
        ),
        migrations.CreateModel(
            name='ImagenProducto',
            fields=[
